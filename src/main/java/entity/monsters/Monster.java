...
public abstract class Monster extends Entity {
  ...
  /**
   * We previously had this in Powerups-and-curse branch protected void move() { switch (direction)
   * { case "up": position.setY(position.getY() - speed); break; case "down":
   * position.setY(position.getY() + speed); break; case "left": position.setX(position.getX() -
   * speed); break; case "right": position.setX(position.getX() + speed); break; } }
   */
