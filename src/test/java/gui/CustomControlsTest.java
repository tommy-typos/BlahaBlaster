...
public class CustomControlsTest {
    ...
    public void testKeyBindings() {
        CustomControlKeyHandler keyHandler = new CustomControlKeyHandler(
                new ControlEventSource(new CustomLabel(""), customControls),
                new CustomLabel(""),
                CustomControlsJson.readControlsFromJson()
        );

        KeyEvent keyEvent = new KeyEvent(customControls, KeyEvent.KEY_RELEASED, System.currentTimeMillis(), 0, KeyEvent.VK_A, 'A');
