...
public class PlayerTest {
    ...
    public void testMoveUpWithoutCollision() {
        keyHandler.w = true;
        player.update();
        assertEquals(97, player.getPosition().y);
    }
    ...
    public void testMoveDownWithoutCollision() {
        keyHandler.s = true;
        player.update();
        assertEquals(103, player.getPosition().y);
    }
    ...
    public void testMoveLeftWithoutCollision() {
        keyHandler.a = true;
        player.update();
        assertEquals(97, player.getPosition().x);
    }
    ...
    public void testMoveRightWithoutCollision() {
        keyHandler.d = true;
        player.update();
        assertEquals(103, player.getPosition().x);
    }
    ...
    public void testMovementBlockedByCollision() {
        ...
        doAnswer(invocation -> {
            player.collisionOn = true;
            return null;
        }).when(collisionChecker).checkTile(player);
