    ...
    public MapEditor(ScreenNavigator navigator, int selectedMapIndex) {
        ...
        for (int i = 0; i < 10; i++) {
            for (int j = 0; j < 10; j++) {
                ...
                int finalI = i;
                int finalJ = j;
                cell_btn.addMouseListener(new MouseAdapter() {
                    @Override
