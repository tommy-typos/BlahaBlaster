...
```
cd existing_repo
git remote add origin https://szofttech.inf.elte.hu/software-technology-2024/group-1/blahablaster.git
git branch -M master
...
- [ ] [Set up project integrations](https://szofttech.inf.elte.hu/software-technology-2024/group-1/blahablaster/-/settings/integrations)
